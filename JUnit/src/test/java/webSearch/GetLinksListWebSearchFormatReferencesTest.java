...
public class GetLinksListWebSearchFormatReferencesTest {
     ...
     *            - Number of results
     */
    public GetLinksListWebSearchFormatReferencesTest(final String objectNameSearch, final int numberSearchResults) {
     ...
     */
    @Test
    public void checkWebListFormatReferencesTest() {
	System.out.println("Starting with the checkWebListFormatReferencesTest of the test parameters:\nSearch for \""
		+ nameObjectSearch + "\"\nThe amount of " + numberResultsSearch);
